		...
		namespace library
		{
			...
			*/
			...
			protected:
				...
				*/
				virtual void listWindows(ArrayList<std::string>& names) const;
				...
				*/
				virtual void listFilesWindows(ArrayList<File>& files) const;
			...
			public:
				...
				*/
				...
				/*
					...
					* @param[out] names The arraylist to place the file names in
				*/
				virtual void list(ArrayList<std::string>& names) const;
