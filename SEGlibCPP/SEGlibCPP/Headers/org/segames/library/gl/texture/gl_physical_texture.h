		...
		namespace library
		{
			...
			*/
			...
			public:
				...
				*/
				explicit GLPhysicalTexture(const Dimension3i& size);
				...
				/*
					...
					* @param[in] size The size of the texture
				*/
				explicit GLPhysicalTexture(const GLenum internalFormat, const Dimension3i& size);
				...
				/*
					...
					* @param[in] size The size of the texture
				*/
				explicit GLPhysicalTexture(const GLenum type, const GLenum internalFormat, const GLenum format, const Dimension3i& size);
