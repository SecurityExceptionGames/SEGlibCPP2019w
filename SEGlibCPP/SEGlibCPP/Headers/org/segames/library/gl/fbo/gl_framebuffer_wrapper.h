			...
			namespace gl
			{
				...
				*/
				...
				protected:
					...
					*/
					static GLAbstractFramebuffer* newSupportedFBO(GLTexture* color, GLTexture* depth, const math::Dimension2i& size);
				...
				public:
					...
					*/
					...
					/*
						...
						* @param[in] size The initial size of the framebuffer
					*/
					explicit GLFramebufferWrapper(const bool color, const bool depth, const math::Dimension2i& size);
					...
					/*
						...
						* @param[in] size The initial size of the framebuffer
					*/
					explicit GLFramebufferWrapper(GLTexture* color, GLTexture* depth, const math::Dimension2i& size);
